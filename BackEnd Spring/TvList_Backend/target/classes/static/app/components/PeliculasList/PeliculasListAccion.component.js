System.register(['angular2/core', 'angular2/router', "../series.service"], function(exports_1, context_1) {
    ...
    var PeliculasListAccionComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            PeliculasListAccionComponent = (function () {
                function PeliculasListAccionComponent(service, router) {
                ...
                PeliculasListAccionComponent.prototype.filtrarPorNombre = function () {
                    this.lista = this.service.getElementoByTitulo(this.busq);
                };
                PeliculasListAccionComponent = __decorate([
                    core_1.Component({
                ...
                ], PeliculasListAccionComponent);
                return PeliculasListAccionComponent;
            }());
            exports_1("PeliculasListAccionComponent", PeliculasListAccionComponent);
        }
    }
});
//# sourceMappingURL=PeliculasListAccion.component.js.map