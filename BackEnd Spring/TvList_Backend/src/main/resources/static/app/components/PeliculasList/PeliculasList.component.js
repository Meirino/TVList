    ...
    return {
        ...
        execute: function() {
            PeliculasListComponent = (function () {
                function PeliculasListComponent(service, router) {
                    this.service = service;
                    this.router = router;
                    this.lista = this.service.filterByPelicula();
                }
                PeliculasListComponent.prototype.filtrarPorNombre = function () {
...
//# sourceMappingURL=PeliculasList.component.js.map