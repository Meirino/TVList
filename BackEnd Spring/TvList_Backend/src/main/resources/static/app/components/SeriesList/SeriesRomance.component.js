System.register(['angular2/core', 'angular2/router', "../series.service"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SeriesRomanceComponent = (function () {
                function SeriesRomanceComponent(service, router) {
                    this.service = service;
                    this.router = router;
                    this.lista = this.service.filterBySeries();
                    this.lista = this.lista.filter(function (serie) { return serie.categorias.indexOf('Romance') > -1; });
                }
                SeriesRomanceComponent.prototype.filtrarPorNombre = function () {
                    this.lista = this.service.getElementoByTitulo(this.busq);
                };
                SeriesRomanceComponent = __decorate([
                    core_1.Component({
                ...
                ], SeriesRomanceComponent);
                return SeriesRomanceComponent;
            }());
            exports_1("SeriesRomanceComponent", SeriesRomanceComponent);
        }
    }
});
//# sourceMappingURL=SeriesRomance.component.js.map