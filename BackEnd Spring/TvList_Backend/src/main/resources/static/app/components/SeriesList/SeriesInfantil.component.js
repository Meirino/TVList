System.register(['angular2/core', 'angular2/router', "../series.service"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SeriesInfantilComponent = (function () {
                function SeriesInfantilComponent(service, router) {
                ...
                SeriesInfantilComponent.prototype.filtrarPorNombre = function () {
                    this.lista = this.service.getElementoByTitulo(this.busq);
                };
                SeriesInfantilComponent = __decorate([
                    core_1.Component({
                ...
                ], SeriesInfantilComponent);
                return SeriesInfantilComponent;
            }());
            exports_1("SeriesInfantilComponent", SeriesInfantilComponent);
        }
    }
});
//# sourceMappingURL=SeriesInfantil.component.js.map