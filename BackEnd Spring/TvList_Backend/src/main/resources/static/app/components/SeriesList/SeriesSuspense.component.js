System.register(['angular2/core', 'angular2/router', "../series.service"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            SeriesSuspenseComponent = (function () {
                function SeriesSuspenseComponent(service, router) {
                ...
                SeriesSuspenseComponent.prototype.filtrarPorNombre = function () {
                    this.lista = this.service.getElementoByTitulo(this.busq);
                };
                SeriesSuspenseComponent = __decorate([
                    core_1.Component({
                ...
                ], SeriesSuspenseComponent);
                return SeriesSuspenseComponent;
            }());
            exports_1("SeriesSuspenseComponent", SeriesSuspenseComponent);
        }
    }
});
//# sourceMappingURL=SeriesSuspense.component.js.map