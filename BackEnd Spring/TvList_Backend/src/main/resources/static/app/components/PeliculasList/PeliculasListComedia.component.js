System.register(['angular2/core', 'angular2/router', "../series.service"], function(exports_1, context_1) {
    ...
    var PeliculasListComediaComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            PeliculasListComediaComponent = (function () {
                function PeliculasListComediaComponent(service, router) {
                ...
                PeliculasListComediaComponent.prototype.filtrarPorNombre = function () {
                    this.lista = this.service.getElementoByTitulo(this.busq);
                };
                PeliculasListComediaComponent = __decorate([
                    core_1.Component({
                ...
                ], PeliculasListComediaComponent);
                return PeliculasListComediaComponent;
            }());
            exports_1("PeliculasListComediaComponent", PeliculasListComediaComponent);
        }
    }
});
//# sourceMappingURL=PeliculasListComedia.component.js.map